                        ...
                        <table class="table table-clear">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        {{number_format(($subtotal - ($subtotal * 0.05)) * 0.02, 0, ',', '.')}}.000</td>
                                </tr>
                                <tr>
                                    <td class="text-start">
                                    ...
                                    <td class="text-end">
                                        <strong
                                            class="text-dark">{{number_format($subtotal - ($subtotal * 0.05) + (($subtotal - ($subtotal * 0.05)) * 0.02), 0, ',', '.')}}.000</strong>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
