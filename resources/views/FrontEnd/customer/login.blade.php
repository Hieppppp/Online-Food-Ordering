...
<body>
    ...
    @if(Session::get('info'))
        <div class="alert-container">
            <div id="autoCloseAlert" class="alert alert-info alert-dismissible fade show" role="alert">
    ...
    <div class="form-container">
        <p class="title">Welcome Standle Food</p>
        <form class="form" action="{{route('check_login')}}" method="post">
            @csrf
            <input type="email" class="input" name="email" placeholder="Email">
            <input type="password" class="input" name="password" placeholder="Password">
            <p class="page-link1">
                <span class="page-link-label1">Forgot Password?</span>
            </p>
            <button type="submit" class="form-btn">Log in</button>
        </form>
        <p class="sign-up-label">
            Don't have an account?<a href="{{route('sign_up')}}"><span class="sign-up-link">Sign up</span></a>
        </p>
